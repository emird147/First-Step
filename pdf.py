...
def generate_pdf(data):
    ...
    concatenated_contact_info = f"{data['personal_info']['email']} | {data['personal_info']['linkedin']} | {data['personal_info']['github']} | {data['personal_info']['location']}"
    ...
    concatenated_prog_languages = f"Programming Languages: {data['skills_info']['prog_languages']}"
    concatenated_applications = f"Applications: {data['skills_info']['applications']}"
    concatenated_os = f"Operating Systems: {data['skills_info']['os']}"
    concatenated_design_software = f"Design Software: {data['skills_info']['design_software']}"
